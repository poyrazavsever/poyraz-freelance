...
const References = () => {
  ...
  return (
    <section className="py-32 bg-neutral-50 dark:bg-neutral-900/50 overflow-hidden">
          ...
          <div className="relative">
            <div className="flex animate-scroll space-x-6">
              {duplicatedTestimonials.map((testimonial, index) => (
                ...
                >
                  <div className="bg-white dark:bg-neutral-800 p-6 rounded-2xl border border-neutral-200 dark:border-neutral-700 h-full">
                    {/* Stars */}
