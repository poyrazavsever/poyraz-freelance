        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {teamMembers.map((member) => (
            ...
            >
              ...
              />
              <h3 className="text-lg font-bold text-dark-bg dark:text-white mb-1">
                {member.name}
              </h3>
              ...
              <div className="flex flex-wrap gap-2 justify-center mt-2">
                {member.skills.map((skill) => (
                  <span
                    key={skill}
                    className="px-3 py-1 bg-primary/10 dark:bg-primary/20 rounded-full text-sm text-dark-bg dark:text-white border border-primary/20 dark:border-primary/10"
                  >
                    {skill}
                  </span>
                ))}
